...
# MD_MAIN_PAGE     - Use the passed .md file for the main page.
#
# MultiValueArgs:
...
function(skyrocket_setup_doxygen TARGET)
    set(_options)
    set(_oneValueArgs BASE_OUTPUT_DIR OUTPUT_DIRECTORY MD_MAIN_PAGE)
    ...
    if (DEFINED ARG_MD_MAIN_PAGE)
        set(MAIN_PAGE_FILE ${ARG_MD_MAIN_PAGE})
    else()
    ...
    get_filename_component(DOXYGEN_USE_MDFILE_AS_MAINPAGE ${MAIN_PAGE_FILE} NAME)
