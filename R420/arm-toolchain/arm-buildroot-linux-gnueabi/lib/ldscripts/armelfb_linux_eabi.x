...
OUTPUT_ARCH(arm)
ENTRY(_start)
SEARCH_DIR("=/home/indu/work/build-system/output/etk_speedwayr_turbo/host/arm-buildroot-linux-gnueabi/lib"); SEARCH_DIR("=/usr/local/lib"); SEARCH_DIR("=/lib"); SEARCH_DIR("=/usr/lib");
SECTIONS
{
